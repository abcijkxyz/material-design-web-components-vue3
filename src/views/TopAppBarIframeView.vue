...
<template>
  <mwc-top-app-bar id="bar">
    ...
    <div id="content">
      <div>
        <mwc-button id="prominentButton" outlined label="toggle prominent"> </mwc-button>
        <mwc-button id="centerButton" outlined label="toggle centerTitle"> </mwc-button>
        <mwc-button id="denseButton" outlined label="toggle dense"> </mwc-button>
        <mwc-button id="customButton" outlined label="toggle custom styles"> </mwc-button>
      </div>
      <p>
